...
if keychain_needs_persona:
    active_persona = keychain_gateway.create_persona("back", "mitm", keychain.SecurityLevel.MEDIUM)

# This should be defined in settings_keychain.py
td_suffix = getattr(settings, 'TRUSTED_DIRECTORY_SUFFIX', '')

keychain_directory = keychain.Directory(keychain_setting, "mitm-legit" + td_suffix, keychain_gateway, 23)
